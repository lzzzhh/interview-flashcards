// backend/src/evaluation/test-cases.ts — 583 条 AI 搜索评测测试集
//
...
export const TEST_CASES: TestCase[] = [
  ...
  { query: "梯度下降", group: "关键词-机器学习", primaryIds: ["ml-11","ml-157"], secondaryIds: [], acceptableDecks: ["machine-learning"], acceptableConcepts: ["梯度下降","SGD","优化器"] },
  { query: "损失函数", group: "关键词-机器学习", primaryIds: ["ml-1","ml-5"], secondaryIds: [], acceptableDecks: ["machine-learning"], acceptableConcepts: ["损失函数","交叉熵","MSE"] },
  { query: "激活函数", group: "关键词-深度学习", primaryIds: ["dl-1","dl-31"], secondaryIds: [], acceptableDecks: ["deep-learning"], acceptableConcepts: ["激活函数","ReLU","sigmoid"] },
  ...
  { query: "强化学习", group: "关键词-机器学习", primaryIds: ["ml-112"], secondaryIds: ["ml-117"], acceptableDecks: ["machine-learning"], acceptableConcepts: ["强化学习","MDP","Q-learning"] },
  ...
  { query: "特征工程", group: "关键词-机器学习", primaryIds: ["ml-13","ml-46"], secondaryIds: [], acceptableDecks: ["machine-learning"], acceptableConcepts: ["特征工程","特征选择"] },
  ...
  { query: "Transformer", group: "关键词-大模型", primaryIds: ["llm-1","llm-3"], secondaryIds: [], acceptableDecks: ["llm"], acceptableConcepts: ["Transformer","Self-Attention"] },
  { query: "BERT", group: "关键词-大模型", primaryIds: ["llm-10"], secondaryIds: ["llm-17"], acceptableDecks: ["llm"], acceptableConcepts: ["BERT","预训练","MLM"] },
  { query: "GPT", group: "关键词-大模型", primaryIds: ["llm-10","llm-7"], secondaryIds: [], acceptableDecks: ["llm"], acceptableConcepts: ["GPT","自回归","decoder"] },
  { query: "多头注意力", group: "关键词-大模型", primaryIds: ["llm-3","llm-9"], secondaryIds: [], acceptableDecks: ["llm"], acceptableConcepts: ["Multi-Head Attention"] },
  ...
  { query: "滑动窗口", group: "关键词-力扣", primaryIds: ["lc-019"], secondaryIds: ["lc-015","lc-016"], acceptableDecks: ["leetcode"], acceptableConcepts: ["滑动窗口","双指针"] },
  { query: "动态规划", group: "关键词-力扣", primaryIds: ["lc-062","lc-067"], secondaryIds: ["lc-069"], acceptableDecks: ["leetcode"], acceptableConcepts: ["DP","动态规划"] },
  { query: "并查集", group: "关键词-力扣", primaryIds: ["lc-083","lc-084"], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["并查集","Union Find"] },
  { query: "拓扑排序", group: "关键词-力扣", primaryIds: ["lc-053"], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["拓扑排序","BFS"] },
  { query: "单调栈", group: "关键词-力扣", primaryIds: ["lc-035","lc-036"], secondaryIds: ["lc-008"], acceptableDecks: ["leetcode"], acceptableConcepts: ["单调栈","接雨水"] },
  { query: "二分查找", group: "关键词-力扣", primaryIds: ["lc-023","lc-024"], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["二分查找","binary search"] },
  { query: "正态分布", group: "关键词-统计学", primaryIds: ["stats-11","stats-101"], secondaryIds: [], acceptableDecks: ["statistics"], acceptableConcepts: ["正态分布","高斯"] },
  { query: "卡方检验", group: "关键词-统计学", primaryIds: ["stats-27","stats-28"], secondaryIds: [], acceptableDecks: ["statistics"], acceptableConcepts: ["卡方检验","独立性检验"] },
  ...
  { query: "线性回归", group: "关键词-统计学", primaryIds: ["stats-47","stats-49"], secondaryIds: [], acceptableDecks: ["statistics"], acceptableConcepts: ["线性回归","OLS"] },
  { query: "朴素贝叶斯", group: "关键词-机器学习", primaryIds: ["ml-28"], secondaryIds: ["stats-9"], acceptableDecks: ["machine-learning","statistics"], acceptableConcepts: ["朴素贝叶斯","贝叶斯"] },
  ...
  { query: "半监督学习", group: "关键词-机器学习", primaryIds: ["ml-111"], secondaryIds: ["ml-10"], acceptableDecks: ["machine-learning"], acceptableConcepts: ["半监督","标签传播"] },
  ...
  { query: "Tool Use", group: "关键词-Agent", primaryIds: ["agent-2","agent-3"], secondaryIds: [], acceptableDecks: ["agent"], acceptableConcepts: ["Tool Use","Function Calling"] },
  ...
  { query: "Agent规划", group: "关键词-Agent", primaryIds: ["agent-4","agent-8"], secondaryIds: [], acceptableDecks: ["agent"], acceptableConcepts: ["规划","Planning"] },
  { query: "Skill", group: "关键词-VibeCoding", primaryIds: ["vc-2","vc-1"], secondaryIds: [], acceptableDecks: ["vibe-coding"], acceptableConcepts: ["Skill"] },
  { query: "颗粒度", group: "关键词-黑话", primaryIds: ["jargon-1"], secondaryIds: [], acceptableDecks: ["jargon"], acceptableConcepts: ["颗粒度","对齐"] },
  { query: "底层逻辑", group: "关键词-黑话", primaryIds: ["jargon-5"], secondaryIds: [], acceptableDecks: ["jargon"], acceptableConcepts: ["底层逻辑","认知"] },
  ...
  { query: "GAN生成对抗", group: "关键词-深度学习", primaryIds: ["dl-11","dl-12"], secondaryIds: [], acceptableDecks: ["deep-learning"], acceptableConcepts: ["GAN","生成对抗"] },
  { query: "Q-learning", group: "关键词-机器学习", primaryIds: ["ml-114"], secondaryIds: ["ml-115"], acceptableDecks: ["machine-learning"], acceptableConcepts: ["Q-learning","DQN"] },
  { query: "余弦相似度", group: "关键词-统计学", primaryIds: ["stats-16"], secondaryIds: ["ml-47"], acceptableDecks: ["statistics","machine-learning"], acceptableConcepts: ["余弦相似度"] },
  ...
  { query: "协方差", group: "关键词-统计学", primaryIds: ["stats-17"], secondaryIds: [], acceptableDecks: ["statistics"], acceptableConcepts: ["协方差","相关系数"] },
  { query: "字典树", group: "关键词-力扣", primaryIds: ["lc-055"], secondaryIds: ["lc-056"], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["Trie","前缀树"] },
  { query: "回文串", group: "关键词-力扣", primaryIds: ["lc-018","lc-039"], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["回文","palindrome"] },
  { query: "岛屿问题", group: "关键词-力扣", primaryIds: ["lc-052"], secondaryIds: [], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["DFS","网格","岛屿"] },
  ...
  { query: "梯度下降", group: "关键词-机器学习", primaryIds: ["ml-11","ml-157"], secondaryIds: [], acceptableDecks: ["machine-learning"], acceptableConcepts: ["梯度下降","SGD"] },
  { query: "损失函数", group: "关键词-机器学习", primaryIds: ["ml-1","ml-5"], secondaryIds: [], acceptableDecks: ["machine-learning"], acceptableConcepts: ["损失函数","交叉熵"] },
  { query: "激活函数", group: "关键词-深度学习", primaryIds: ["dl-1","dl-31"], secondaryIds: [], acceptableDecks: ["deep-learning"], acceptableConcepts: ["激活函数","ReLU"] },
  { query: "卷积神经网络", group: "关键词-深度学习", primaryIds: ["dl-14"], secondaryIds: ["dl-6","dl-18"], acceptableDecks: ["deep-learning"], acceptableConcepts: ["CNN"] },
  { query: "RNN", group: "关键词-深度学习", primaryIds: ["dl-9","dl-10"], secondaryIds: [], acceptableDecks: ["deep-learning"], acceptableConcepts: ["RNN","LSTM"] },
  { query: "Dropout", group: "关键词-深度学习", primaryIds: ["dl-4"], secondaryIds: [], acceptableDecks: ["deep-learning"], acceptableConcepts: ["Dropout"] },
  { query: "迁移学习", group: "关键词-机器学习", primaryIds: ["ml-149","ml-147"], secondaryIds: [], acceptableDecks: ["machine-learning"], acceptableConcepts: ["迁移学习"] },
  { query: "强化学习", group: "关键词-机器学习", primaryIds: ["ml-112"], secondaryIds: ["ml-117"], acceptableDecks: ["machine-learning"], acceptableConcepts: ["RL","MDP"] },
  { query: "聚类算法", group: "关键词-机器学习", primaryIds: ["ml-21","ml-23"], secondaryIds: [], acceptableDecks: ["machine-learning"], acceptableConcepts: ["聚类","KMeans"] },
  { query: "降维", group: "关键词-机器学习", primaryIds: ["ml-22","ml-26"], secondaryIds: [], acceptableDecks: ["machine-learning"], acceptableConcepts: ["PCA","t-SNE"] },
  { query: "特征工程", group: "关键词-机器学习", primaryIds: ["ml-13","ml-46"], secondaryIds: [], acceptableDecks: ["machine-learning"], acceptableConcepts: ["特征工程"] },
  { query: "偏差方差", group: "关键词-机器学习", primaryIds: ["ml-8"], secondaryIds: [], acceptableDecks: ["machine-learning"], acceptableConcepts: ["偏差","方差"] },
  { query: "Adam优化器", group: "关键词-深度学习", primaryIds: ["dl-30"], secondaryIds: [], acceptableDecks: ["deep-learning"], acceptableConcepts: ["Adam"] },
  { query: "Transformer", group: "关键词-大模型", primaryIds: ["llm-1","llm-3"], secondaryIds: [], acceptableDecks: ["llm"], acceptableConcepts: ["Transformer"] },
  { query: "BERT", group: "关键词-大模型", primaryIds: ["llm-10"], secondaryIds: ["llm-17"], acceptableDecks: ["llm"], acceptableConcepts: ["BERT","MLM"] },
  { query: "GPT", group: "关键词-大模型", primaryIds: ["llm-10","llm-7"], secondaryIds: [], acceptableDecks: ["llm"], acceptableConcepts: ["GPT"] },
  { query: "多头注意力", group: "关键词-大模型", primaryIds: ["llm-3","llm-9"], secondaryIds: [], acceptableDecks: ["llm"], acceptableConcepts: ["Multi-Head"] },
  { query: "残差连接", group: "关键词-大模型", primaryIds: ["llm-2","dl-8"], secondaryIds: [], acceptableDecks: ["llm","deep-learning"], acceptableConcepts: ["ResNet"] },
  { query: "归一化", group: "关键词-深度学习", primaryIds: ["dl-3","dl-22"], secondaryIds: [], acceptableDecks: ["deep-learning"], acceptableConcepts: ["BatchNorm"] },
  { query: "词嵌入", group: "关键词-大模型", primaryIds: ["llm-6"], secondaryIds: ["ml-89"], acceptableDecks: ["llm","machine-learning"], acceptableConcepts: ["Embedding"] },
  { query: "滑动窗口", group: "关键词-力扣", primaryIds: ["lc-019"], secondaryIds: ["lc-015","lc-016"], acceptableDecks: ["leetcode"], acceptableConcepts: ["滑动窗口"] },
  { query: "动态规划", group: "关键词-力扣", primaryIds: ["lc-062","lc-067"], secondaryIds: ["lc-069"], acceptableDecks: ["leetcode"], acceptableConcepts: ["DP"] },
  { query: "并查集", group: "关键词-力扣", primaryIds: ["lc-083","lc-084"], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["UnionFind"] },
  { query: "拓扑排序", group: "关键词-力扣", primaryIds: ["lc-053"], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["拓扑排序"] },
  { query: "单调栈", group: "关键词-力扣", primaryIds: ["lc-035","lc-036"], secondaryIds: ["lc-008"], acceptableDecks: ["leetcode"], acceptableConcepts: ["单调栈"] },
  { query: "二分查找", group: "关键词-力扣", primaryIds: ["lc-023","lc-024"], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["二分查找"] },
  { query: "正态分布", group: "关键词-统计学", primaryIds: ["stats-11","stats-101"], secondaryIds: [], acceptableDecks: ["statistics"], acceptableConcepts: ["正态分布"] },
  { query: "卡方检验", group: "关键词-统计学", primaryIds: ["stats-27","stats-28"], secondaryIds: [], acceptableDecks: ["statistics"], acceptableConcepts: ["卡方检验"] },
  { query: "方差分析", group: "关键词-统计学", primaryIds: ["stats-29"], secondaryIds: ["stats-30"], acceptableDecks: ["statistics"], acceptableConcepts: ["ANOVA"] },
  { query: "线性回归", group: "关键词-统计学", primaryIds: ["stats-47","stats-49"], secondaryIds: [], acceptableDecks: ["statistics"], acceptableConcepts: ["OLS"] },
  { query: "朴素贝叶斯", group: "关键词-机器学习", primaryIds: ["ml-28"], secondaryIds: ["stats-9"], acceptableDecks: ["machine-learning","statistics"], acceptableConcepts: ["贝叶斯"] },
  { query: "随机梯度下降", group: "关键词-机器学习", primaryIds: ["ml-157","ml-11"], secondaryIds: [], acceptableDecks: ["machine-learning"], acceptableConcepts: ["SGD"] },
  { query: "半监督学习", group: "关键词-机器学习", primaryIds: ["ml-111"], secondaryIds: ["ml-10"], acceptableDecks: ["machine-learning"], acceptableConcepts: ["半监督"] },
  ...
  { query: "Tool Use", group: "关键词-Agent", primaryIds: ["agent-2","agent-3"], secondaryIds: [], acceptableDecks: ["agent"], acceptableConcepts: ["ToolUse"] },
  { query: "Reranking", group: "关键词-Agent", primaryIds: ["agent-25"], secondaryIds: [], acceptableDecks: ["agent"], acceptableConcepts: ["重排序"] },
  { query: "Agent记忆", group: "关键词-Agent", primaryIds: ["agent-21"], secondaryIds: ["agent-5"], acceptableDecks: ["agent"], acceptableConcepts: ["Memory"] },
  { query: "Agent规划", group: "关键词-Agent", primaryIds: ["agent-4","agent-8"], secondaryIds: [], acceptableDecks: ["agent"], acceptableConcepts: ["Planning"] },
  { query: "Skill", group: "关键词-VibeCoding", primaryIds: ["vc-2","vc-1"], secondaryIds: [], acceptableDecks: ["vibe-coding"], acceptableConcepts: ["Skill"] },
  { query: "颗粒度", group: "关键词-黑话", primaryIds: ["jargon-1"], secondaryIds: [], acceptableDecks: ["jargon"], acceptableConcepts: ["颗粒度"] },
  { query: "底层逻辑", group: "关键词-黑话", primaryIds: ["jargon-5"], secondaryIds: [], acceptableDecks: ["jargon"], acceptableConcepts: ["底层逻辑"] },
  { query: "述职", group: "关键词-职场", primaryIds: ["wp-3","wp-8"], secondaryIds: [], acceptableDecks: ["workplace"], acceptableConcepts: ["述职"] },
  { query: "Precision F1", group: "关键词-机器学习", primaryIds: ["ml-49","ml-51"], secondaryIds: [], acceptableDecks: ["machine-learning"], acceptableConcepts: ["F1"] },
  ...
  { query: "Q-learning", group: "关键词-机器学习", primaryIds: ["ml-114"], secondaryIds: ["ml-115"], acceptableDecks: ["machine-learning"], acceptableConcepts: ["DQN"] },
  { query: "余弦相似度", group: "关键词-统计学", primaryIds: ["stats-16"], secondaryIds: ["ml-47"], acceptableDecks: ["statistics"], acceptableConcepts: ["余弦"] },
  { query: "MLE", group: "关键词-统计学", primaryIds: ["stats-100","stats-109"], secondaryIds: [], acceptableDecks: ["statistics"], acceptableConcepts: ["MLE"] },
  { query: "先验后验", group: "关键词-统计学", primaryIds: ["stats-9","stats-15"], secondaryIds: [], acceptableDecks: ["statistics"], acceptableConcepts: ["贝叶斯"] },
  { query: "协方差", group: "关键词-统计学", primaryIds: ["stats-17"], secondaryIds: [], acceptableDecks: ["statistics"], acceptableConcepts: ["协方差"] },
  { query: "字典树", group: "关键词-力扣", primaryIds: ["lc-055"], secondaryIds: ["lc-056"], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["Trie"] },
  { query: "回文串", group: "关键词-力扣", primaryIds: ["lc-018","lc-039"], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["回文"] },
  { query: "岛屿问题", group: "关键词-力扣", primaryIds: ["lc-052"], secondaryIds: [], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["DFS"] },
  ...
  { query: "背包问题", group: "关键词-力扣", primaryIds: ["lc-073"], secondaryIds: ["lc-071"], acceptableDecks: ["leetcode"], acceptableConcepts: ["背包"] },
  { query: "迭代", group: "关键词-黑话", primaryIds: ["jargon-24","jargon-37"], secondaryIds: [], acceptableDecks: ["jargon"], acceptableConcepts: ["迭代"] },
  { query: "特征缩放", group: "关键词-机器学习", primaryIds: ["ml-13","ml-45"], secondaryIds: [], acceptableDecks: ["machine-learning"], acceptableConcepts: ["特征缩放"] },
  { query: "背包问题", group: "关键词-力扣", primaryIds: ["lc-073"], secondaryIds: ["lc-071"], acceptableDecks: ["leetcode"], acceptableConcepts: ["背包"] },
  { query: "梯度下降", group: "关键词-机器学习", primaryIds: ["ml-11","ml-57"], secondaryIds: [], acceptableDecks: ["machine-learning"], acceptableConcepts: ["梯度下降","SGD","优化器"] },
  { query: "损失函数", group: "关键词-机器学习", primaryIds: ["ml-1","ml-142"], secondaryIds: [], acceptableDecks: ["machine-learning"], acceptableConcepts: ["损失函数","交叉熵","MSE"] },
  { query: "激活函数", group: "关键词-深度学习", primaryIds: ["dl-1","dl-24"], secondaryIds: [], acceptableDecks: ["deep-learning"], acceptableConcepts: ["激活函数","ReLU"] },
  { query: "Dropout", group: "关键词-深度学习", primaryIds: ["dl-4"], secondaryIds: ["dl-4"], acceptableDecks: ["deep-learning"], acceptableConcepts: ["Dropout","过拟合"] },
  { query: "BERT", group: "关键词-大模型", primaryIds: ["llm-10"], secondaryIds: ["llm-12"], acceptableDecks: ["llm"], acceptableConcepts: ["BERT","MLM","预训练"] },
  { query: "GPT", group: "关键词-大模型", primaryIds: ["llm-10","llm-24"], secondaryIds: [], acceptableDecks: ["llm"], acceptableConcepts: ["GPT","自回归"] },
  { query: "并查集", group: "关键词-力扣", primaryIds: ["lc-053","lc-052"], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["并查集","UnionFind"] },
  { query: "拓扑排序", group: "关键词-力扣", primaryIds: ["lc-053"], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["拓扑排序","BFS"] },
  { query: "单调栈", group: "关键词-力扣", primaryIds: ["lc-030","lc-008"], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["单调栈"] },
  { query: "正态分布", group: "关键词-统计学", primaryIds: ["stats-11","stats-114"], secondaryIds: [], acceptableDecks: ["statistics"], acceptableConcepts: ["正态分布","高斯"] },
  { query: "卡方检验", group: "关键词-统计学", primaryIds: ["stats-27"], secondaryIds: [], acceptableDecks: ["statistics"], acceptableConcepts: ["卡方检验"] },
  { query: "线性回归", group: "关键词-统计学", primaryIds: ["stats-47","stats-49"], secondaryIds: [], acceptableDecks: ["statistics"], acceptableConcepts: ["OLS","线性回归"] },
  { query: "朴素贝叶斯", group: "关键词-机器学习", primaryIds: ["ml-5","ml-71"], secondaryIds: [], acceptableDecks: ["machine-learning","statistics"], acceptableConcepts: ["朴素贝叶斯"] },
  { query: "Function Calling", group: "关键词-Agent", primaryIds: ["agent-2"], secondaryIds: [], acceptableDecks: ["agent"], acceptableConcepts: ["Function Calling"] },
  { query: "颗粒度", group: "关键词-黑话", primaryIds: ["jargon-1"], secondaryIds: [], acceptableDecks: ["jargon"], acceptableConcepts: ["颗粒度"] },
  { query: "底层逻辑", group: "关键词-黑话", primaryIds: ["jargon-5"], secondaryIds: [], acceptableDecks: ["jargon"], acceptableConcepts: ["底层逻辑"] },
  { query: "GAN生成对抗网络", group: "关键词-深度学习", primaryIds: ["dl-11","dl-12"], secondaryIds: [], acceptableDecks: ["deep-learning"], acceptableConcepts: ["GAN"] },
  { query: "余弦相似度", group: "关键词-统计学", primaryIds: ["ml-59"], secondaryIds: ["agent-19"], secondaryIds: [], acceptableDecks: ["statistics"], acceptableConcepts: ["余弦相似度"] },
  { query: "贝叶斯定理", group: "关键词-统计学", primaryIds: ["stats-15","stats-39"], secondaryIds: [], acceptableDecks: ["statistics"], acceptableConcepts: ["贝叶斯","先验","后验"] },
  { query: "协方差", group: "关键词-统计学", primaryIds: ["stats-17"], secondaryIds: [], acceptableDecks: ["statistics"], acceptableConcepts: ["协方差","相关系数"] },
  { query: "字典树Trie", group: "关键词-力扣", primaryIds: ["lc-055","lc-056"], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["Trie"] },
  { query: "岛屿问题", group: "关键词-力扣", primaryIds: ["lc-040","lc-052"], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["DFS","岛屿"] },
  { query: "背包问题", group: "关键词-力扣", primaryIds: ["lc-073","lc-074"], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["背包"] },
  { query: "特征工程", group: "关键词-机器学习", primaryIds: ["ml-129","ml-13"], secondaryIds: [], acceptableDecks: ["machine-learning"], acceptableConcepts: ["特征工程"] },
  { query: "MCP协议", group: "关键词-VibeCoding", primaryIds: ["vc-17","vc-5"], secondaryIds: [], acceptableDecks: ["vibe-coding"], acceptableConcepts: ["MCP"] },
  { query: "梯度下降", group: "关键词-机器学习", primaryIds: ["ml-11","ml-57"], secondaryIds: ["ml-58"], acceptableDecks: ["machine-learning"], acceptableConcepts: ["梯度下降|SGD"] },
  { query: "损失函数", group: "关键词-机器学习", primaryIds: ["ml-1","ml-142"], secondaryIds: ["ml-144"], acceptableDecks: ["machine-learning"], acceptableConcepts: ["损失函数|交叉熵"] },
  { query: "激活函数", group: "关键词-深度学习", primaryIds: ["dl-1","dl-24"], secondaryIds: [], acceptableDecks: ["deep-learning"], acceptableConcepts: ["激活函数"] },
  ...
  { query: "Dropout", group: "关键词-深度学习", primaryIds: ["dl-4"], secondaryIds: [], acceptableDecks: ["deep-learning"], acceptableConcepts: ["Dropout"] },
  { query: "Transformer", group: "关键词-大模型", primaryIds: ["llm-1","llm-2"], secondaryIds: ["llm-38"], acceptableDecks: ["llm"], acceptableConcepts: ["Transformer|Self-Att"] },
  ...
  { query: "多头注意力", group: "关键词-大模型", primaryIds: ["llm-3"], secondaryIds: [], acceptableDecks: ["llm"], acceptableConcepts: ["Multi-Head"] },
  ...
  { query: "滑动窗口", group: "关键词-力扣", primaryIds: ["lc-022"], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["Sliding|滑动"] },
  ...
  { query: "单调栈", group: "关键词-力扣", primaryIds: ["lc-008","lc-029"], secondaryIds: ["lc-030"], acceptableDecks: ["leetcode"], acceptableConcepts: ["Daily|Trapping|Min S"] },
  { query: "二分查找", group: "关键词-力扣", primaryIds: ["lc-024","lc-026"], secondaryIds: ["lc-040"], acceptableDecks: ["leetcode"], acceptableConcepts: ["Search|Binary"] },
  { query: "正态分布", group: "关键词-统计学", primaryIds: ["stats-11","stats-114"], secondaryIds: [], acceptableDecks: ["statistics"], acceptableConcepts: ["正态分布"] },
  { query: "卡方检验", group: "关键词-统计学", primaryIds: ["stats-27"], secondaryIds: [], acceptableDecks: ["statistics"], acceptableConcepts: ["卡方"] },
  ...
  { query: "线性回归", group: "关键词-统计学", primaryIds: ["stats-47","stats-49"], secondaryIds: ["stats-54"], acceptableDecks: ["statistics"], acceptableConcepts: ["线性回归"] },
  { query: "朴素贝叶斯", group: "关键词-机器学习", primaryIds: ["ml-5","ml-71"], secondaryIds: [], acceptableDecks: ["machine-learning"], acceptableConcepts: ["贝叶斯"] },
  ...
  { query: "Skill", group: "关键词-VibeCoding", primaryIds: ["vc-1","vc-10"], secondaryIds: ["vc-2"], acceptableDecks: ["vibe-coding"], acceptableConcepts: ["skill|command"] },
  { query: "颗粒度", group: "关键词-黑话", primaryIds: ["jargon-1"], secondaryIds: [], acceptableDecks: ["jargon"], acceptableConcepts: ["颗粒度"] },
  { query: "底层逻辑", group: "关键词-黑话", primaryIds: ["jargon-5"], secondaryIds: [], acceptableDecks: ["jargon"], acceptableConcepts: ["逻辑"] },
  { query: "述职汇报", group: "关键词-职场", primaryIds: ["wp-3","wp-7"], secondaryIds: [], acceptableDecks: ["workplace"], acceptableConcepts: ["述职|汇报"] },
  { query: "Precision F1", group: "关键词-机器学习", primaryIds: ["ml-184","ml-49"], secondaryIds: ["ml-56"], acceptableDecks: ["machine-learning"], acceptableConcepts: ["Precision|F1|精确率"] },
  { query: "L1 L2正则化", group: "关键词-机器学习", primaryIds: ["ml-10"], secondaryIds: [], acceptableDecks: ["machine-learning"], acceptableConcepts: ["正则化"] },
  { query: "GAN生成对抗", group: "关键词-深度学习", primaryIds: ["dl-11","dl-12"], secondaryIds: ["dl-14"], acceptableDecks: ["deep-learning"], acceptableConcepts: ["GAN"] },
  { query: "Q-learning", group: "关键词-机器学习", primaryIds: ["ml-114"], secondaryIds: [], acceptableDecks: ["machine-learning"], acceptableConcepts: ["Q-Learning|DQN"] },
  ...
  { query: "贝叶斯定理", group: "关键词-统计学", primaryIds: ["stats-15","stats-39"], secondaryIds: ["stats-41"], acceptableDecks: ["statistics"], acceptableConcepts: ["贝叶斯"] },
  { query: "协方差", group: "关键词-统计学", primaryIds: ["stats-146","stats-17"], secondaryIds: [], acceptableDecks: ["statistics"], acceptableConcepts: ["协方差"] },
  { query: "Trie字典树", group: "关键词-力扣", primaryIds: ["lc-055"], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["Trie|Prefix"] },
  { query: "回文串", group: "关键词-力扣", primaryIds: ["lc-018","lc-039"], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["Palindr|回文"] },
  ...
  { query: "背包问题", group: "关键词-力扣", primaryIds: ["lc-074","lc-076"], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["Partition|Knapsack|B"] },
  ...
  { query: "特征工程", group: "关键词-机器学习", primaryIds: ["ml-129","ml-13"], secondaryIds: ["ml-138"], acceptableDecks: ["machine-learning"], acceptableConcepts: ["特征"] },
  ...
  { query: "位置编码", group: "关键词-大模型", primaryIds: ["llm-4"], secondaryIds: [], acceptableDecks: ["llm"], acceptableConcepts: ["位置编码|Positional"] },
  ...
  { query: "MCP协议", group: "关键词-VibeCoding", primaryIds: ["vc-17","vc-5"], secondaryIds: [], acceptableDecks: ["vibe-coding"], acceptableConcepts: ["MCP"] },
  { query: "Agent规划", group: "关键词-Agent", primaryIds: ["agent-5","agent-6"], secondaryIds: [], acceptableDecks: ["agent"], acceptableConcepts: ["Planning|规划|AutoGPT"] },
  { query: "半监督学习", group: "关键词-机器学习", primaryIds: ["ml-118","ml-122"], secondaryIds: ["ml-146"], acceptableDecks: ["machine-learning"], acceptableConcepts: ["自监督|半监督"] },
  ...
  { query: "假设检验", group: "关键词-统计学", primaryIds: ["stats-105","stats-107"], secondaryIds: ["stats-119"], acceptableDecks: ["statistics"], acceptableConcepts: ["假设检验|t.*检验"] },
  ...
  { query: "怎么判断两个变量之间有没有关系", group: "概念-统计学", primaryIds: ["stats-115","stats-138"], secondaryIds: ["stats-140","ml-1"], acceptableDecks: ["statistics"], acceptableConcepts: ["相关|回归"] },
  ...
  { query: "为什么Transformer比RNN快", group: "概念-大模型", primaryIds: ["llm-1","llm-2"], secondaryIds: ["llm-38","dl-9"], acceptableDecks: ["llm"], acceptableConcepts: ["并行|Transformer|Self-"] },
  { query: "大模型为什么胡编乱造", group: "概念-大模型", primaryIds: ["agent-10","agent-11"], secondaryIds: [], acceptableDecks: ["llm"], acceptableConcepts: ["幻觉|事实性|RAG"] },
  ...
  { query: "Agent和LLM到底什么关系", group: "概念-Agent", primaryIds: ["agent-1","agent-2"], secondaryIds: ["agent-21","llm-16"], acceptableDecks: ["agent"], acceptableConcepts: ["Agent|LLM|关系"] },
  ...
  { query: "推荐系统学习路线", group: "learning-path", primaryIds: ["ml-103","ml-117"], secondaryIds: ["ml-133","stats-124"], acceptableDecks: ["machine-learning"], acceptableConcepts: ["推荐|协同过滤"] },
  { query: "CV图像分类学习路线", group: "learning-path", primaryIds: ["dl-6","ml-155"], secondaryIds: ["ml-185"], acceptableDecks: ["deep-learning"], acceptableConcepts: ["CNN|图像|分类"] },
  { query: "LLM大模型学习路线", group: "learning-path", primaryIds: ["llm-10","llm-18"], secondaryIds: ["llm-21","dl-17"], acceptableDecks: ["llm"], acceptableConcepts: ["Transformer|GPT|LLM"] },
  { query: "时间序列预测学习路线", group: "learning-path", primaryIds: ["stats-86","stats-88"], secondaryIds: ["stats-91","ml-148"], acceptableDecks: ["statistics"], acceptableConcepts: ["时间序列|ARIMA|Prophet"] },
  { query: "NLP文本分类学习路线", group: "learning-path", primaryIds: ["llm-10","ml-109"], secondaryIds: ["ml-110"], acceptableDecks: ["llm"], acceptableConcepts: ["NLP|BERT|文本.*分类"] },
  ...
  { query: "图神经网络学习路线", group: "learning-path", primaryIds: ["ml-102","ml-103"], secondaryIds: [], acceptableDecks: ["deep-learning"], acceptableConcepts: ["图.*神经|Graph.*Neural"] },
  ...
  { query: "想做算法工程师要学什么", group: "learning-path", primaryIds: ["ml-134","ml-136"], secondaryIds: ["ml-189","dl-10"], acceptableDecks: ["machine-learning"], acceptableConcepts: ["机器学习|深度学习|基础"] },
  { query: "本科生想做数据科学要掌握什么", group: "learning-path", primaryIds: ["ml-166","ml-167"], secondaryIds: [], acceptableDecks: ["statistics"], acceptableConcepts: ["数据科学|统计分析|Python"] },
  { query: "后端转算法要补什么", group: "learning-path", primaryIds: ["ml-10","ml-134"], secondaryIds: ["ml-136","stats-101"], acceptableDecks: ["machine-learning"], acceptableConcepts: ["机器学习|统计|数学"] },
  { query: "想学推荐系统需要什么数学基础", group: "learning-path", primaryIds: ["ml-103","ml-11"], secondaryIds: ["ml-117","stats-124"], acceptableDecks: ["machine-learning"], acceptableConcepts: ["推荐|矩阵|优化"] },
  ...
  { query: "模型部署从哪开始学", group: "learning-path", primaryIds: ["llm-21","llm-26"], secondaryIds: ["llm-25","ml-160"], acceptableDecks: ["llm"], acceptableConcepts: ["部署|推理|ONNX|vLLM"] },
  { query: "为什么学NLP先学Transformer", group: "learning-path", primaryIds: ["llm-1","llm-2"], secondaryIds: ["llm-26","dl-25"], acceptableDecks: ["llm"], acceptableConcepts: ["Transformer|NLP|Atte"] },
  { query: "自学CS基础要学哪些课", group: "learning-path", primaryIds: ["ml-113","ml-115"], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["数据结构|算法|操作系统"] },
  ...
  { query: "小众但卷的AI赛道有哪些", group: "learning-path", primaryIds: ["ml-57"], secondaryIds: [], acceptableDecks: ["llm"], acceptableConcepts: ["赛道|方向|趋势"] },
  { query: "从零学AI需要哪些数学", group: "learning-path", primaryIds: ["stats-15","stats-44"], secondaryIds: [], acceptableDecks: ["machine-learning"], acceptableConcepts: ["线性代数|概率|微积分"] },
  ...
  { query: "想进FAANG要学哪些技术", group: "learning-path", primaryIds: ["ml-113","ml-115"], secondaryIds: [], acceptableDecks: ["leetcode"], acceptableConcepts: ["算法|系统设计|FAANG"] },
  ...
  { query: "BatchNorm和LayerNorm什么时候用哪个", group: "跨模块-深度vs大模型", primaryIds: ["dl-21","dl-22"], secondaryIds: ["dl-3","llm-38"], acceptableDecks: ["deep-learning"], acceptableConcepts: ["Batch.*Norm|Layer.*N"] },
  ...
  { query: "RNN和Transformer大不同", group: "跨模块-深度vs大模型", primaryIds: ["dl-24","dl-7"], secondaryIds: ["dl-9","llm-38"], acceptableDecks: ["deep-learning"], acceptableConcepts: ["RNN|LSTM|Transformer"] },
  ...
  { query: "怎么搞懂反向传播", group: "回归-对抗", primaryIds: ["dl-2","dl-5"], secondaryIds: ["ml-1","ml-106"], acceptableDecks: ["deep-learning"], acceptableConcepts: ["反向.*传播|BP|梯度"] },
