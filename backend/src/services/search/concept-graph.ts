...
const NODES: ConceptNode[] = [{ id: 'ensemble', canonical: '集成学习', aliases: ["集成学习","ensemble learning"], deckHint: 'machine-learning', parentCategory: '机器学习',
    coreKeywords: ["集成学习","ensemble learning"], searchAliases: ["ensemble","模型融合","元学习","meta learning"],
    relations: [{"type":"parent","target":"ml"},{"type":"child","target":"bagging"},{"type":"child","target":"boosting"},{"type":"child","target":"stacking"},{"type":"implementation","target":"random_forest"},{"type":"implementation","target":"gbdt"},{"type":"implementation","target":"xgboost"},{"type":"related","target":"decision_tree"},{"type":"related","target":"overfitting"},{"type":"related","target":"feature_importance"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'xgboost', canonical: 'XGBoost', aliases: ["XGBoost","xgboost","extreme gradient boosting"], deckHint: 'machine-learning', parentCategory: '机器学习',
    ...
    relations: [{"type":"parent","target":"gbdt"},{"type":"parent","target":"boosting"},{"type":"child","target":"ml"},{"type":"related","target":"random_forest"},{"type":"related","target":"feature_importance"},{"type":"related","target":"regularization"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'random_forest', canonical: '随机森林', aliases: ["随机森林","random forest"], deckHint: 'machine-learning', parentCategory: '机器学习',
    ...
    relations: [{"type":"parent","target":"bagging"},{"type":"child","target":"decision_tree"},{"type":"related","target":"feature_importance"},{"type":"contrast","target":"gbdt"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'bagging', canonical: 'Bagging', aliases: ["Bagging","bagging","bootstrap aggregating"], deckHint: 'machine-learning', parentCategory: '机器学习',
    ...
    relations: [{"type":"parent","target":"ensemble"},{"type":"child","target":"random_forest"},{"type":"related","target":"overfitting"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'boosting', canonical: 'Boosting', aliases: ["Boosting","boosting"], deckHint: 'machine-learning', parentCategory: '机器学习',
    ...
    relations: [{"type":"parent","target":"ensemble"},{"type":"child","target":"gbdt"},{"type":"related","target":"overfitting"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'gbdt', canonical: 'GBDT', aliases: ["GBDT","gradient boosted decision trees"], deckHint: 'machine-learning', parentCategory: '机器学习',
    ...
    relations: [{"type":"parent","target":"boosting"},{"type":"child","target":"xgboost"},{"type":"related","target":"decision_tree"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'decision_tree', canonical: '决策树', aliases: ["决策树","decision tree"], deckHint: 'machine-learning', parentCategory: '机器学习',
    ...
    relations: [{"type":"foundation","target":"random_forest"},{"type":"foundation","target":"gbdt"},{"type":"related","target":"overfitting"},{"type":"related","target":"regularization"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'overfitting', canonical: '过拟合', aliases: ["过拟合","overfitting"], deckHint: 'machine-learning', parentCategory: '机器学习',
    ...
    relations: [{"type":"related","target":"regularization"},{"type":"related","target":"decision_tree"},{"type":"related","target":"cross_validation"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'regularization', canonical: '正则化', aliases: ["正则化","regularization"], deckHint: 'machine-learning', parentCategory: '机器学习',
    ...
    relations: [{"type":"related","target":"overfitting"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'feature_importance', canonical: '特征重要性', aliases: ["特征重要性","feature importance"], deckHint: 'machine-learning', parentCategory: '机器学习',
    ...
    relations: [{"type":"related","target":"random_forest"},{"type":"related","target":"xgboost"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'graph_algorithm', canonical: '图算法', aliases: ["图算法","图","graph algorithm","graph","graph theory","图论"], deckHint: 'leetcode', parentCategory: '算法',
    ...
    relations: [{"type":"child","target":"bfs"},{"type":"child","target":"dfs"},{"type":"child","target":"shortest_path"},{"type":"child","target":"topo_sort"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'bfs', canonical: 'BFS', aliases: ["BFS","广度优先搜索","breadth first search"], deckHint: 'leetcode', parentCategory: '算法',
    ...
    relations: [{"type":"parent","target":"graph_algorithm"},{"type":"contrast","target":"dfs"},{"type":"related","target":"shortest_path"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'dfs', canonical: 'DFS', aliases: ["DFS","深度优先搜索","depth first search"], deckHint: 'leetcode', parentCategory: '算法',
    ...
    relations: [{"type":"parent","target":"graph_algorithm"},{"type":"contrast","target":"bfs"},{"type":"related","target":"backtracking"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'shortest_path', canonical: '最短路', aliases: ["最短路","shortest path"], deckHint: 'leetcode', parentCategory: '算法',
    ...
    relations: [{"type":"parent","target":"graph_algorithm"},{"type":"related","target":"bfs"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'topo_sort', canonical: '拓扑排序', aliases: ["拓扑排序","topological sort"], deckHint: 'leetcode', parentCategory: '算法',
    ...
    relations: [{"type":"parent","target":"graph_algorithm"},{"type":"related","target":"bfs"},{"type":"related","target":"dfs"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'hash_table', canonical: '哈希表', aliases: ["哈希表","hash table"], deckHint: 'leetcode', parentCategory: '算法',
    ...
    relations: [{"type":"related","target":"array"},{"type":"contrast","target":"two_pointer"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'array', canonical: '数组', aliases: ["数组","array"], deckHint: 'leetcode', parentCategory: '算法',
    ...
    relations: [{"type":"related","target":"hash_table"},{"type":"related","target":"two_pointer"},{"type":"related","target":"sliding_window"},{"type":"foundation","target":"dynamic_programming"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'two_pointer', canonical: '双指针', aliases: ["双指针","two pointer"], deckHint: 'leetcode', parentCategory: '算法',
    ...
    relations: [{"type":"related","target":"sliding_window"},{"type":"contrast","target":"hash_table"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'sliding_window', canonical: '滑动窗口', aliases: ["滑动窗口","sliding window"], deckHint: 'leetcode', parentCategory: '算法',
    ...
    relations: [{"type":"related","target":"two_pointer"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'dynamic_programming', canonical: '动态规划', aliases: ["动态规划","DP","dynamic programming"], deckHint: 'leetcode', parentCategory: '算法',
    ...
    relations: [{"type":"foundation","target":"array"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'transformer', canonical: 'Transformer', aliases: ["Transformer","transformer"], deckHint: 'deep-learning', parentCategory: '深度学习',
    ...
    relations: [{"type":"child","target":"attention"},{"type":"foundation","target":"rag"},{"type":"foundation","target":"agent"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'attention', canonical: 'Attention', aliases: ["Attention","注意力机制","attention mechanism"], deckHint: 'deep-learning', parentCategory: '深度学习',
    coreKeywords: ["Attention","注意力","attention mechanism"], searchAliases: ["attention","self attention","multi head","qkv","query key value","transformer","attention is all you need","multi-head","scaled dot product","softmax"],
    relations: [{"type":"parent","target":"transformer"},{"type":"implementation","target":"transformer"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'rag', canonical: 'RAG', aliases: ["RAG","retrieval augmented generation"], deckHint: 'agent', parentCategory: 'Agent',
    ...
    relations: [{"type":"related","target":"embedding"},{"type":"related","target":"vector_db"},{"type":"contrast","target":"agent"},{"type":"prerequisite","target":"embedding"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'agent', canonical: 'Agent', aliases: ["Agent","智能体","AI Agent"], deckHint: 'agent', parentCategory: 'Agent',
    ...
    relations: [{"type":"contrast","target":"rag"},{"type":"related","target":"rag"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'embedding', canonical: 'Embedding', aliases: ["Embedding","嵌入","向量表示"], deckHint: 'agent', parentCategory: '大模型',
    ...
    relations: [{"type":"related","target":"vector_db"},{"type":"related","target":"rag"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'vector_db', canonical: 'Vector DB', aliases: ["Vector DB","向量数据库"], deckHint: 'agent', parentCategory: '大模型',
    ...
    relations: [{"type":"related","target":"embedding"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'ml', canonical: '机器学习', aliases: ["机器学习","machine learning"], deckHint: 'machine-learning', parentCategory: '机器学习',
    ...
    relations: [{"type":"child","target":"ensemble"}], migrationStatus: 'manual', domain: 'machine-learning',
  },
{ id: 'backtracking', canonical: '回溯', aliases: ["回溯","回溯算法","backtracking"], deckHint: 'leetcode', parentCategory: '算法',
    ...
    relations: [{"type":"related","target":"dfs"}], migrationStatus: 'generated', domain: '',
  },
{ id: 'reinforcement_learning', canonical: '强化学习', aliases: ["强化学习","reinforcement learning","RL"], deckHint: 'machine-learning', parentCategory: '机器学习',
    ...
    relations: [{"type":"related","target":"ml"}], migrationStatus: 'generated', domain: '',
  },
{ id: 'pca', canonical: 'PCA', aliases: ["PCA","principal component analysis"], deckHint: 'machine-learning', parentCategory: '机器学习',
    ...
    relations: [], migrationStatus: 'generated', domain: '',
  },
...
{ id: 'cross_validation', canonical: '交叉验证', aliases: ["交叉验证","cross validation"], deckHint: 'machine-learning', parentCategory: '机器学习',
    ...
    relations: [{"type":"related","target":"overfitting"}], migrationStatus: 'generated', domain: '',
  },
...
{ id: 'rnn', canonical: 'RNN', aliases: ["RNN","recurrent neural network","LSTM"], deckHint: 'deep-learning', parentCategory: '深度学习',
    coreKeywords: ["RNN","recurrent neural network","LSTM"], searchAliases: ["rnn","lstm","gru","序列","sequence","GRU","梯度消失","time step","时序","BPTT","vanishing gradient","recurrent"],
    relations: [], migrationStatus: 'generated', domain: '',
  },
...
{ id: 'dropout', canonical: 'Dropout', aliases: ["Dropout","drop out"], deckHint: 'deep-learning', parentCategory: '深度学习',
    ...
    relations: [{"type":"related","target":"regularization"}], migrationStatus: 'generated', domain: '',
  },
...
{ id: 'dl', canonical: '深度学习', aliases: ["深度学习","deep learning"], deckHint: 'deep-learning', parentCategory: '深度学习',
    ...
    relations: [{"type":"child","target":"cnn"},{"type":"child","target":"rnn"},{"type":"child","target":"transformer"},{"type":"foundation","target":"ml"}], migrationStatus: 'generated', domain: '',
  },
...
{ id: 'lightgbm', canonical: 'LightGBM', aliases: ["LightGBM","lightgbm"], deckHint: 'machine-learning', parentCategory: '机器学习',
    coreKeywords: ["LightGBM","light gbm"], searchAliases: ["LightGBM","light gbm"],
    relations: [], migrationStatus: 'generated', domain: 'machine-learning',
  },
{ id: 'catboost', canonical: 'CatBoost', aliases: ["CatBoost","catboost"], deckHint: 'machine-learning', parentCategory: '机器学习',
    coreKeywords: ["CatBoost"], searchAliases: ["CatBoost"],
    relations: [], migrationStatus: 'generated', domain: 'machine-learning',
  },
{ id: 'qlearning', canonical: 'Q-learning', aliases: ["Q-learning"], deckHint: 'machine-learning', parentCategory: '机器学习',
    coreKeywords: ["Q-learning","Q value","Q函数"], searchAliases: ["Q-learning","Q value","Q函数"],
    relations: [], migrationStatus: 'generated', domain: 'machine-learning',
  },
{ id: 'pandas', canonical: 'pandas', aliases: ["pandas"], deckHint: 'statistics', parentCategory: '数据科学',
...
{ id: 'leetcode', canonical: 'LeetCode', aliases: ["LeetCode"], deckHint: 'leetcode', parentCategory: '算法',
    coreKeywords: ["LeetCode","刷题","算法"], searchAliases: ["LeetCode","刷题","算法"],
    relations: [], migrationStatus: 'generated', domain: 'leetcode',
  },
{ id: 'layernorm', canonical: 'LayerNorm', aliases: ["LayerNorm"], deckHint: 'deep-learning', parentCategory: '深度学习',
...
{ id: 'prompt', canonical: 'Prompt', aliases: ["Prompt"], deckHint: 'llm', parentCategory: '大模型',
...
{ id: 'finetuning', canonical: 'Fine-tuning', aliases: ["Fine-tuning"], deckHint: 'llm', parentCategory: '大模型',
    coreKeywords: ["Fine-tuning","微调","fine tune"], searchAliases: ["Fine-tuning","微调","fine tune"],
    relations: [], migrationStatus: 'generated', domain: 'llm-agent-rag',
  },
{ id: 'function_calling', canonical: 'Function Calling', aliases: ["Function Calling"], deckHint: 'agent', parentCategory: 'Agent',
    coreKeywords: ["Function Calling","工具调用","tool use"], searchAliases: ["Function Calling","工具调用","tool use"],
    relations: [], migrationStatus: 'generated', domain: 'llm-agent-rag',
  },
{ id: 'vibecoding', canonical: 'VibeCoding', aliases: ["VibeCoding"], deckHint: 'vibe-coding', parentCategory: 'VibeCoding',
...
{ id: 'git', canonical: 'Git', aliases: ["Git"], deckHint: 'workplace', parentCategory: '',
    coreKeywords: ["Git","版本控制","分支","merge","rebase","longitudinal","ChiMerge","BASE","version control","commit"], searchAliases: ["Git","版本控制","分支"],
    relations: [], migrationStatus: 'generated', domain: 'workplace-vibecoding',
  },
{ id: 'hypothesis_test', canonical: '假设检验', aliases: ["假设检验","hypothesis testing","统计检验","Hypothesis Testing"], deckHint: 'statistics', parentCategory: '统计学',
...
{ id: 'confidence_interval', canonical: '置信区间', aliases: ["置信区间"], deckHint: 'statistics', parentCategory: '统计学',
    coreKeywords: ["置信区间","confidence interval"], searchAliases: ["置信区间","confidence interval"],
    relations: [], migrationStatus: 'generated', domain: 'data-science-statistics',
  },
{ id: 'image_classification', canonical: '图像分类', aliases: ["图像分类"], deckHint: 'deep-learning', parentCategory: '深度学习',
    coreKeywords: ["图像分类","image classification"], searchAliases: ["图像分类","image classification"],
    relations: [], migrationStatus: 'generated', domain: 'deep-learning',
  },
{ id: 'data_cleaning', canonical: '数据清洗', aliases: ["数据清洗"], deckHint: 'statistics', parentCategory: '数据科学',
    coreKeywords: ["数据清洗","data cleaning"], searchAliases: ["数据清洗","data cleaning"],
    relations: [], migrationStatus: 'generated', domain: 'data-science-statistics',
  },
{ id: 'backpropagation', canonical: '反向传播', aliases: ["反向传播"], deckHint: 'deep-learning', parentCategory: '深度学习',
    coreKeywords: ["反向传播","backpropagation"], searchAliases: ["反向传播","backpropagation"],
    relations: [], migrationStatus: 'generated', domain: 'deep-learning',
  },
{ id: 'gradient_descent', canonical: '梯度下降', aliases: ["梯度下降"], deckHint: 'deep-learning', parentCategory: '深度学习',
    coreKeywords: ["梯度下降","gradient descent"], searchAliases: ["梯度下降","gradient descent"],
    relations: [], migrationStatus: 'generated', domain: 'deep-learning',
  },
{ id: 'greedy_alg', canonical: '贪心', aliases: ["贪心"], deckHint: 'leetcode', parentCategory: '算法',
    coreKeywords: ["贪心","greedy"], searchAliases: ["贪心","greedy"],
    relations: [], migrationStatus: 'generated', domain: 'leetcode',
  },
{ id: 'algorithms', canonical: '算法', aliases: ["算法"], deckHint: 'leetcode', parentCategory: '算法',
    coreKeywords: ["算法","algorithm"], searchAliases: ["算法","algorithm"],
    relations: [{"type":"foundation","target":"sql"}], migrationStatus: 'generated', domain: 'leetcode',
  },
{ id: 'llm_big_model', canonical: '大模型', aliases: ["大模型"], deckHint: 'llm', parentCategory: '大模型',
    coreKeywords: ["大模型","LLM","GPT"], searchAliases: ["大模型","LLM","GPT"],
    relations: [], migrationStatus: 'generated', domain: 'llm-agent-rag',
  },
{ id: 'stack_queue', canonical: '栈和队列', aliases: ["栈和队列"], deckHint: 'leetcode', parentCategory: '算法',
    coreKeywords: ["栈","队列","stack","queue"], searchAliases: ["栈","队列","stack"],
    relations: [], migrationStatus: 'generated', domain: 'leetcode',
  },
{ id: 'workplace_comm', canonical: '职场沟通', aliases: ["职场沟通","职场"], deckHint: 'workplace', parentCategory: '职场',
    coreKeywords: ["职场","沟通","汇报"], searchAliases: ["职场","沟通","汇报"],
    relations: [], migrationStatus: 'generated', domain: 'workplace-vibecoding',
  },
{ id: 'probability_cn', canonical: '概率', aliases: ["概率"], deckHint: 'statistics', parentCategory: '统计学',
    coreKeywords: ["概率","probability"], searchAliases: ["概率","probability"],
    relations: [], migrationStatus: 'generated', domain: 'data-science-statistics',
  },
{ id: 'prefix_sum', canonical: '前缀和', aliases: ["前缀和"], deckHint: 'leetcode', parentCategory: '算法',
    coreKeywords: ["前缀和","prefix sum"], searchAliases: ["前缀和","prefix sum"],
    relations: [], migrationStatus: 'generated', domain: 'leetcode',
  },
{ id: 'mono_stack', canonical: '单调栈', aliases: ["单调栈"], deckHint: 'leetcode', parentCategory: '算法',
    coreKeywords: ["单调栈","monotonic stack"], searchAliases: ["单调栈","monotonic stack"],
    relations: [], migrationStatus: 'generated', domain: 'leetcode',
  },
{ id: 'connectivity', canonical: '连通性', aliases: ["连通性"], deckHint: 'leetcode', parentCategory: '算法',
    coreKeywords: ["连通性","connectivity"], searchAliases: ["连通性","connectivity"],
    relations: [], migrationStatus: 'generated', domain: 'leetcode',
  },
{ id: 'statistics_cn', canonical: '统计学', aliases: ["统计学"], deckHint: 'statistics', parentCategory: '',
...
{ id: 'node_85', canonical: '图', aliases: ["图"], deckHint: 'leetcode', parentCategory: '',
...
{ id: 'tree', canonical: '树', aliases: ["树"], deckHint: 'leetcode', parentCategory: '',
...
{ id: 'sorting', canonical: '排序', aliases: ["排序"], deckHint: 'leetcode', parentCategory: '',
...
{ id: 'prompt_engineering', canonical: 'Prompt Engineering', aliases: ["Prompt Engineering","prompt engineering","提示工程","提示词"], deckHint: 'llm', parentCategory: '大模型',
    ...
    relations: [{"type":"parent","target":"llm"},{"type":"foundation","target":"llm"}], migrationStatus: 'generated', domain: 'llm-agent-rag',
  },
...
{ id: 'batch_norm_dl', canonical: 'BatchNorm', aliases: ["BatchNorm","Batch Normalization","批归一化"], deckHint: 'deep-learning', parentCategory: '深度学习',
    coreKeywords: ["BatchNorm","batch normalization"], searchAliases: ["batchnorm","batch norm","normalization","BN","internal covariate shift","批归一化"],
    relations: [{"type":"parent","target":"dl"},{"type":"related","target":"regularization"},{"type":"contrast","target":"layernorm"}], migrationStatus: 'generated', domain: 'deep-learning',
  },
{ id: 'cross_entropy', canonical: 'Cross Entropy', aliases: ["Cross Entropy","交叉熵","cross entropy loss","CE"], deckHint: 'deep-learning', parentCategory: '深度学习',
    coreKeywords: ["cross entropy","交叉熵","log loss","CE loss"], searchAliases: ["cross entropy","交叉熵","log loss","CE","categorical crossentropy","binary crossentropy","softmax loss","negative log likelihood","NLL"],
    relations: [{"type":"parent","target":"dl"},{"type":"related","target":"loss_function"}], migrationStatus: 'generated', domain: 'deep-learning',
  },
{ id: 'mle', canonical: '最大似然估计', aliases: ["最大似然估计","Maximum Likelihood","MLE","极大似然"], deckHint: 'statistics', parentCategory: '统计学',
    coreKeywords: ["maximum likelihood","最大似然","MLE","对数似然","似然函数"], searchAliases: ["maximum likelihood","MLE","likelihood","log likelihood","极大似然","parameter estimation","EM","expectation maximization"],
    relations: [{"type":"parent","target":"statistics"},{"type":"related","target":"probability"}], migrationStatus: 'generated', domain: 'data-science-statistics',
  },
{ id: 'model_deploy', canonical: '模型部署', aliases: ["模型部署","model deployment","模型上线","MLOps"], deckHint: 'mlops', parentCategory: 'MLOps',
    coreKeywords: ["模型部署","model deployment","MLOps","模型服务","推理"], searchAliases: ["model deployment","模型部署","MLOps","serving","inference","onnx","tensorrt","triton","torchserve","fastapi","flask","docker"],
    relations: [{"type":"foundation","target":"ml"}], migrationStatus: 'generated', domain: 'machine-learning',
  },
{ id: 'distributed_system', canonical: '分布式系统', aliases: ["分布式系统","distributed system","分布式计算"], deckHint: 'data-engineering', parentCategory: '数据工程',
    coreKeywords: ["分布式","distributed","一致性","consensus","CAP","Raft","Paxos"], searchAliases: ["分布式","distributed","consensus","CAP","Raft","Paxos","leader","replication","sharding","zookeeper","etcd"],
    relations: [{"type":"prerequisite","target":"sql"}], migrationStatus: 'generated', domain: 'data-science-statistics',
  },
{ id: 'star_method', canonical: 'STAR法则', aliases: ["STAR法则","STAR method","S.T.A.R.","行为面试"], deckHint: 'workplace', parentCategory: '职场',
    coreKeywords: ["STAR","Situation","Task","Action","Result","行为面试"], searchAliases: ["star","STAR","行为面试","behavioral","自我介绍","面试技巧"],
    relations: [], migrationStatus: 'generated', domain: 'workplace-vibecoding',
  },
{ id: 'cicd_pipeline', canonical: 'CI/CD流水线', aliases: ["CI/CD流水线","CICD pipeline","CI/CD pipeline","持续集成流水线"], deckHint: 'data-engineering', parentCategory: '数据工程',
    coreKeywords: ["CI/CD","持续集成","持续部署","pipeline","Jenkins","GitHub Actions"], searchAliases: ["ci/cd","cicd","github actions","jenkins","pipeline","deploy","自动化","artifact","docker","k8s","terraform","ansible"],
    relations: [], migrationStatus: 'generated', domain: 'data-science-statistics',
  },
{ id: 'agent_dev', canonical: 'Agent开发', aliases: ["Agent开发","Agent Development","Agent构建"], deckHint: 'agent', parentCategory: 'Agent',
    coreKeywords: ["Agent开发","agent development"], searchAliases: ["agent dev","agent development","agent构建","智能体开发","agent framework"],
    relations: [{"type":"parent","target":"agent"},{"type":"prerequisite","target":"tool_use"},{"type":"related","target":"function_calling"}], migrationStatus: 'generated', domain: 'llm-agent-rag',
  },
{ id: 'nlp', canonical: 'NLP', aliases: ["NLP","自然语言处理","Natural Language Processing","NLU"], deckHint: 'deep-learning', parentCategory: '大模型',
    coreKeywords: ["NLP","自然语言处理","NLU","文本分类","named entity recognition"], searchAliases: ["nlp","natural language processing","NLU","text classification","NER","tokenization","stemming","lemmatization"],
    relations: [{"type":"parent","target":"dl"},{"type":"prerequisite","target":"transformer"},{"type":"related","target":"llm"}], migrationStatus: 'generated', domain: 'deep-learning',
  },
{ id: 'cv', canonical: 'CV', aliases: ["CV","计算机视觉","Computer Vision","图像识别"], deckHint: 'deep-learning', parentCategory: '深度学习',
    coreKeywords: ["CV","计算机视觉","Computer Vision","图像分类","object detection"], searchAliases: ["cv","computer vision","image classification","object detection","CNN","segmentation","YOLO","ResNet"],
    relations: [{"type":"parent","target":"dl"},{"type":"prerequisite","target":"cnn"}], migrationStatus: 'generated', domain: 'deep-learning',
  },
{ id: 'ab_test', canonical: 'AB测试', aliases: ["AB测试","ab test","AB Test"], deckHint: 'statistics', parentCategory: '统计学',
    coreKeywords: ["AB测试","AB test","control group","实验设计"], searchAliases: ["ab test","AB testing","control","treatment","实验组","对照组","假设检验"],
    relations: [{"type":"parent","target":"statistics"},{"type":"related","target":"hypothesis_test"}], migrationStatus: 'generated', domain: 'data-science-statistics',
  },
{ id: 'cicd_node', canonical: 'CI/CD流水线', aliases: ["CI/CD流水线","CI/CD","ci/cd pipeline"], deckHint: 'data-engineering', parentCategory: '数据工程',
    coreKeywords: ["CI/CD","ci/cd","流水线","Jenkins","GitHub Actions"], searchAliases: ["ci/cd","cicd","cicd pipeline","jenkins","github actions","devops","自动化部署"],
    relations: [{"type":"parent","target":"cicd"},{"type":"prerequisite","target":"cicd"}], migrationStatus: 'generated', domain: 'data-science-statistics',
  },
{ id: 'llm_big', canonical: '大模型', aliases: ["大模型","LLM","large language model"], deckHint: 'llm', parentCategory: '大模型',
    coreKeywords: ["大模型","LLM","GPT","预训练","微调"], searchAliases: ["llm","large language model","大模型","GPT","BERT","预训练","transformer","scaling law"],
