...
{ id: 'rag', canonical: 'RAG', aliases: ['RAG', 'retrieval augmented generation'], deckHint: 'agent', parentCategory: 'Agent',
    ...
    relations: [{type:'foundation',target:'llm_big_model'},{type:'prerequisite',target:'embedding'},
...
{ id: 'agent', canonical: 'Agent', aliases: ['Agent', '智能体', 'AI Agent'], deckHint: 'agent', parentCategory: 'Agent',
    ...
    relations: [{type:'prerequisite',target:'tool_use'},
...
{ id: 'ml', canonical: '机器学习', aliases: ['机器学习', 'machine learning'], deckHint: 'machine-learning', parentCategory: '机器学习',
    ...
    relations: [{type:'foundation',target:'statistics_cn'},{type:'child',target:'feature_engineering'},
...
{ id: 'dl', canonical: '深度学习', aliases: ['深度学习', 'deep learning'], deckHint: 'deep-learning', parentCategory: '深度学习',
    ...
    relations: [{type:'prerequisite',target:'ml'},{type:'foundation',target:'ml'},{ type: 'child', target: 'cnn' }, { type: 'child', target: 'rnn' }, { type: 'child', target: 'transformer' }] },
...
{ id: 'algorithms', canonical: '算法', aliases: ['算法'],
    ...
    relations: [{type:'prerequisite',target:'data_structure'},{type:'foundation',target:'data_structure'},], migrationStatus: 'generated', domain: 'leetcode',
  },
{ id: 'llm_big_model', canonical: '大模型', aliases: ['大模型'],
    deckHint: 'llm', parentCategory: '大模型',
    coreKeywords: ['大模型', 'LLM', 'GPT'], searchAliases: ['大模型', 'LLM', 'GPT'],
    relations: [{type:'foundation',target:'transformer'},{type:'prerequisite',target:'transformer'},], migrationStatus: 'generated', domain: 'llm-agent-rag',
  },
...
{ id: 'statistics_cn', canonical: '统计学', aliases: ['统计学'],
    ...
    relations: [{type:'prerequisite',target:'probability'},], migrationStatus: 'generated', domain: 'data-science-statistics',
  },
...
{ id: 'prompt_engineering', canonical: 'Prompt Engineering', aliases: ['Prompt Engineering','prompt engineering','提示工程','提示词'], deckHint: 'llm', parentCategory: '大模型',
    ...
    relations: [{type:'parent',target:'llm'},{type:'foundation',target:'llm'},{type:'prerequisite',target:'transformer'}], migrationStatus: 'generated', domain: 'llm-agent-rag',
  },
{ id: 'tool_use', canonical: 'Tool Use', aliases: ['Tool Use','tool use','工具调用','Function Calling','function calling'], deckHint: 'agent', parentCategory: 'Agent',
    ...
    relations: [{type:'parent',target:'agent'},{type:'prerequisite',target:'llm_big_model'},{type:'related',target:'json_mode'}], migrationStatus: 'generated', domain: 'llm-agent-rag',
  },
...
{ id: 'model_deploy', canonical: '模型部署', aliases: ['模型部署','model deployment','模型上线','MLOps'], deckHint: 'mlops', parentCategory: 'MLOps',
    ...
    relations: [{type:'foundation',target:'sql'},{type:'prerequisite',target:'docker'},{type:'foundation',target:'ml'},{type:'prerequisite',target:'cicd'},], migrationStatus: 'generated', domain: 'machine-learning',
  },
{ id: 'distributed_system', canonical: '分布式系统', aliases: ['分布式系统','distributed system','分布式计算'], deckHint: 'data-engineering', parentCategory: '数据工程',
    ...
    relations: [{type:'foundation',target:'sql'},{type:'prerequisite',target:'sql'},], migrationStatus: 'generated', domain: 'data-science-statistics',
  },
...
{ id: 'agent_dev', canonical: 'Agent开发', aliases: ['Agent开发','Agent Development','Agent构建'], deckHint: 'agent', parentCategory: 'Agent',
    ...
    relations: [{type:'parent',target:'agent'},{type:'prerequisite',target:'tool_use'}], migrationStatus: 'generated', domain: 'llm-agent-rag',
  },
{ id: 'nlp', canonical: 'NLP', aliases: ['NLP','自然语言处理','NLU'], deckHint: 'deep-learning', parentCategory: '大模型',
    coreKeywords: ['NLP','自然语言处理','NLU','text classification','NER'], searchAliases: ['nlp','natural language processing','NLU','text classification','tokenization','stemming'],
    relations: [{type:'parent',target:'dl'},{type:'prerequisite',target:'transformer'}], migrationStatus: 'generated', domain: 'deep-learning',
  },
{ id: 'cv', canonical: 'CV', aliases: ['CV','计算机视觉','Computer Vision','图像分类','object detection'], deckHint: 'deep-learning', parentCategory: '深度学习',
    coreKeywords: ['CV','计算机视觉','Computer Vision','image classification'], searchAliases: ['cv','computer vision','image classification','object detection','CNN','segmentation','YOLO','ResNet'],
    relations: [{type:'parent',target:'dl'},{type:'prerequisite',target:'cnn'}], migrationStatus: 'generated', domain: 'deep-learning',
  },
{ id: 'ab_test', canonical: 'AB测试', aliases: ['AB测试','ab test','AB实验'], deckHint: 'statistics', parentCategory: '统计学',
    coreKeywords: ['AB测试','AB test','control group','实验设计'], searchAliases: ['ab test','AB testing','control','treatment','实验组','对照组'],
    relations: [{type:'parent',target:'statistics_cn'},{type:'related',target:'hypothesis_test'}], migrationStatus: 'generated', domain: 'data-science-statistics',
  },
{ id: 'function_calling_detail', canonical: 'Function Calling', aliases: ['Function Calling','function calling','函数调用','tool calling'], deckHint: 'agent', parentCategory: 'Agent',
    coreKeywords: ['Function Calling','function calling','tool call','API call'], searchAliases: ['function call','tool calling','API calling','openai functions','tool use','function'],
    relations: [{type:'parent',target:'agent'},{type:'related',target:'tool_use'}], migrationStatus: 'generated', domain: 'llm-agent-rag',
  },
{ id: 'structured_output', canonical: 'Structured Output', aliases: ['Structured Output','structured output','结构化输出','JSON Output'], deckHint: 'agent', parentCategory: 'Agent',
    coreKeywords: ['Structured Output','structured output','JSON Mode','JSON输出'], searchAliases: ['structured output','JSON output','json mode','structured','format'],
    relations: [{type:'parent',target:'agent'},{type:'related',target:'json_mode'}], migrationStatus: 'generated', domain: 'llm-agent-rag',
  },
  { id: 'gnn', canonical: 'GNN', aliases: ['GNN','图神经网络','graph neural network'], deckHint: 'deep-learning', parentCategory: '深度学习',
    coreKeywords: ['GNN','图神经网络','graph neural network'], searchAliases: ['gnn','graph neural','图神经网络','graph convolution','node embedding'],
    relations: [{type:'parent',target:'dl'},{type:'prerequisite',target:'transformer'}], migrationStatus: 'generated', domain: 'deep-learning',
  },
  { id: 'causal_inference', canonical: '因果推断', aliases: ['因果推断','causal inference'], deckHint: 'statistics', parentCategory: '统计学',
    coreKeywords: ['因果推断','causal inference','DAG','do-calculus'], searchAliases: ['causal','因果','do-calculus','counterfactual','ATE','ITE','PSM','IV'],
    relations: [{type:'prerequisite',target:'statistics_cn'},{type:'parent',target:'statistics_cn'}], migrationStatus: 'generated', domain: 'data-science-statistics',
  },
  { id: 'spark', canonical: 'Spark', aliases: ['Spark','Apache Spark','大数据'], deckHint: 'data-engineering', parentCategory: '数据工程',
    coreKeywords: ['Spark','大数据','RDD','DataFrame'], searchAliases: ['spark','apache spark','RDD','DataFrame','Spark SQL','MLlib'],
    relations: [{type:'parent',target:'data_engineering'}], migrationStatus: 'generated', domain: 'data-science-statistics',
  },
  { id: 'recommendation', canonical: '推荐系统', aliases: ['推荐系统','recommendation system','recommender'], deckHint: 'machine-learning', parentCategory: '机器学习',
    coreKeywords: ['推荐系统','recommendation','collaborative filtering','协同过滤'], searchAliases: ['recommendation','recommender','协同过滤','collaborative filtering','content-based','matrix factorization','SVD','recall','NDCG','CTR'],
    relations: [{type:'foundation',target:'ml'},{type:'parent',target:'ml'}], migrationStatus: 'generated', domain: 'machine-learning',
  },
  { id: 'time_series', canonical: '时间序列', aliases: ['时间序列','time series','时序预测'], deckHint: 'statistics', parentCategory: '统计学',
    coreKeywords: ['时间序列','time series','ARIMA','forecasting'], searchAliases: ['time series','ARIMA','SARIMA','prophet','seasonality','趋势','平稳性','ACF','PACF'],
    relations: [{type:'prerequisite',target:'probability'},{type:'parent',target:'statistics_cn'}], migrationStatus: 'generated', domain: 'data-science-statistics',
  },
  { id: 'ctr', canonical: 'CTR预估', aliases: ['CTR预估','CTR','点击率预估'], deckHint: 'machine-learning', parentCategory: '机器学习',
    coreKeywords: ['CTR','点击率','CTR预估','广告'], searchAliases: ['ctr','click through rate','广告','推荐','ranking','排序'],
    relations: [{type:'parent',target:'ml'}], migrationStatus: 'generated', domain: 'machine-learning',
  },
  { id: 'risk_control', canonical: '风控', aliases: ['风控','风险控制','风控建模'], deckHint: 'machine-learning', parentCategory: '机器学习',
    coreKeywords: ['风控','risk control','反欺诈','评分卡'], searchAliases: ['风控','risk','fraud','反欺诈','信用评分','评分卡','异常检测'],
    relations: [{type:'parent',target:'ml'}], migrationStatus: 'generated', domain: 'machine-learning',
  },
