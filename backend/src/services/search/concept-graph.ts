...
const NODES: ConceptNode[] = [
  ...
  { id: 'rag', canonical: 'RAG', aliases: ['RAG', 'retrieval augmented generation'], deckHint: 'agent', parentCategory: 'Agent',
    ...
    relations: [{type:'prerequisite',target:'embedding'},
  ...
  { id: 'ml', canonical: '机器学习', aliases: ['机器学习', 'machine learning'], deckHint: 'machine-learning', parentCategory: '机器学习',
    ...
    relations: [{type:'child',target:'feature_engineering'},
  ...
  { id: 'dl', canonical: '深度学习', aliases: ['深度学习', 'deep learning'], deckHint: 'deep-learning', parentCategory: '深度学习',
    ...
    relations: [{type:'foundation',target:'ml'},{ type: 'child', target: 'cnn' }, { type: 'child', target: 'rnn' }, { type: 'child', target: 'transformer' }] },
  ...
  { id: 'algorithms', canonical: '算法', aliases: ['算法'],
    ...
    relations: [{type:'foundation',target:'data_structure'},], migrationStatus: 'generated', domain: 'leetcode',
  },
  { id: 'llm_big_model', canonical: '大模型', aliases: ['大模型'],
    deckHint: 'llm', parentCategory: '大模型',
    coreKeywords: ['大模型', 'LLM', 'GPT'], searchAliases: ['大模型', 'LLM', 'GPT'],
    relations: [{type:'prerequisite',target:'transformer'},], migrationStatus: 'generated', domain: 'llm-agent-rag',
  },
  ...
  { id: 'model_deploy', canonical: '模型部署', aliases: ['模型部署','model deployment','模型上线','MLOps'], deckHint: 'mlops', parentCategory: 'MLOps',
    ...
    relations: [{type:'foundation',target:'ml'},{type:'prerequisite',target:'cicd'},], migrationStatus: 'generated', domain: 'machine-learning',
  },
