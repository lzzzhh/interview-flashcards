...
const ALL_CASES: LPCase[] = [
  ...
  // ══════════ CATEGORY 6: 对比混淆 (20) ══════════
  { id:'lp146', query:'数组和哈希表有什么区别，应该先学哪个', expectedIntent:'create_plan', expectedTopic:'哈希表', expectedDeckHint:D.LC, expectedParent:'算法', expectedConcepts:['哈希表','数组','hash','array'], mustMatchAny:['哈希表','数组','hash'], maxMerged:250, minFinal:3, category:'对比混淆', domain:'LeetCode', style:'X和Y有什么区别' },
  { id:'lp147', query:'什么时候用双指针什么时候用哈希表', expectedIntent:'create_plan', expectedTopic:'双指针', expectedDeckHint:D.LC, expectedParent:'算法', expectedConcepts:['双指针','哈希表','two pointer','hash'], mustMatchAny:['双指针','哈希表','two pointer'], maxMerged:250, minFinal:3, category:'对比混淆', domain:'LeetCode', style:'什么时候用X' },
  { id:'lp148', query:'Bagging和Boosting怎么区分', expectedIntent:'create_plan', expectedTopic:'Bagging', expectedDeckHint:D.ML, expectedParent:'机器学习', expectedConcepts:['Bagging','Boosting','集成学习','随机森林','GBDT'], mustMatchAny:['Bagging','Boosting','集成学习'], maxMerged:200, minFinal:3, category:'对比混淆', domain:'机器学习', style:'X和Y怎么区分' },
  { id:'lp149', query:'RAG和Agent有什么区别', expectedIntent:'create_plan', expectedTopic:'RAG', expectedDeckHint:D.AG, expectedParent:'Agent', expectedConcepts:['RAG','Agent','retrieval','tool use'], mustMatchAny:['RAG','Agent'], maxMerged:120, minFinal:2, category:'对比混淆', domain:'大模型', style:'X和Y有什么区别' },
  ...
  { id:'lp168', query:'动态规划我看了几遍还是不懂，先学哪些卡比较好', expectedIntent:'create_plan', expectedTopic:'动态规划', expectedDeckHint:D.LC, expectedParent:'算法', expectedConcepts:['动态规划','DP'], mustMatchAny:['动态规划','DP','dynamic programming'], maxMerged:200, minFinal:3, category:'口语长句', domain:'LeetCode', style:'X看了几遍还不懂' },
