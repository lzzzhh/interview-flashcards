...
const ALL_CASES: LPCase[] = [
  ...
  { id:'lp147', query:'什么时候用双指针什么时候用哈希表', expectedIntent:'compare_cards', acceptableIntents:['compare_cards','create_plan'], expectedTopic:'双指针', expectedDeckHint:D.LC, expectedParent:'算法', expectedConcepts:['双指针','哈希表','two pointer','hash'], mustMatchAny:['双指针','哈希表','two pointer'], maxMerged:250, minFinal:3, category:'对比混淆', domain:'LeetCode', style:'什么时候用X' },
  { id:'lp148', query:'Bagging和Boosting怎么区分', expectedIntent:'compare_cards', acceptableIntents:['compare_cards','create_plan'], expectedTopic:'Bagging', expectedDeckHint:D.ML, expectedParent:'机器学习', expectedConcepts:['Bagging','Boosting','集成学习','随机森林','GBDT'], mustMatchAny:['Bagging','Boosting','集成学习'], maxMerged:200, minFinal:3, category:'对比混淆', domain:'机器学习', style:'X和Y怎么区分' },
  { id:'lp149', query:'RAG和Agent有什么区别', expectedIntent:'compare_cards', acceptableIntents:['compare_cards','create_plan'], expectedTopic:'RAG', expectedDeckHint:D.AG, expectedParent:'Agent', expectedConcepts:['RAG','Agent','retrieval','tool use'], mustMatchAny:['RAG','Agent'], maxMerged:120, minFinal:2, category:'对比混淆', domain:'大模型', style:'X和Y有什么区别' },
  { id:'lp150', query:'batch norm和layer norm怎么学', expectedIntent:'create_plan', acceptableIntents:['create_plan','compare_cards'], expectedTopic:'BatchNorm', expectedDeckHint:D.DL, expectedParent:'深度学习', expectedConcepts:['BatchNorm','LayerNorm','normalization'], mustMatchAny:['BatchNorm','LayerNorm','normalization'], maxMerged:100, minFinal:2, category:'对比混淆', domain:'深度学习', style:'X和Y怎么学' },
