...
const ALL_CASES: LPCase[] = [
  ...
  { id:'lp015', topicGranularity:'medium', query:'怎么学回溯算法', expectedIntent:'create_plan', expectedTopic:'回溯', expectedDeckHint:D.LC, expectedParent:'算法', expectedConcepts:['回溯','backtracking','DFS'], mustMatchAny:['回溯','backtracking'], maxMerged:150, minFinal:2, category:'标准学习路线', domain:'LeetCode', style:'怎么学X' },
  ...
  { id:'lp017', topicGranularity:'medium', query:'怎么学强化学习', expectedIntent:'create_plan', expectedTopic:'强化学习', expectedDeckHint:D.ML, expectedParent:'机器学习', expectedConcepts:['强化学习','MDP','Q-learning','policy gradient'], mustMatchAny:['强化学习','Q-learning','policy'], maxMerged:100, minFinal:1, category:'标准学习路线', domain:'机器学习', style:'怎么学X' },
  { id:'lp018', topicGranularity:'medium', query:'PCA怎么学', expectedIntent:'create_plan', expectedTopic:'PCA', expectedDeckHint:D.ML, expectedParent:'机器学习', expectedConcepts:['PCA','降维','特征值'], mustMatchAny:['PCA','降维','eigen'], maxMerged:100, minFinal:1, category:'标准学习路线', domain:'机器学习', style:'X怎么学' },
  { id:'lp019', topicGranularity:'medium', query:'如何系统学习特征工程', expectedIntent:'create_plan', expectedTopic:'特征工程', expectedDeckHint:D.ML, expectedParent:'机器学习', expectedConcepts:['特征工程','特征选择','特征缩放'], mustMatchAny:['特征工程','特征','feature'], maxMerged:200, minFinal:2, category:'标准学习路线', domain:'机器学习', style:'如何系统学习X' },
  ...
  { id:'lp059', topicGranularity:'medium', query:'正则化老是搞混，推荐学习顺序', expectedIntent:'create_plan', expectedTopic:'正则化', expectedDeckHint:D.ML, expectedParent:'机器学习', expectedConcepts:['正则化','L1','L2','dropout'], mustMatchAny:['正则化','L1','L2'], maxMerged:100, minFinal:1, category:'复习补弱', domain:'机器学习', style:'X老是搞混' },
  { id:'lp060', topicGranularity:'medium', query:'我对概率论很薄弱', expectedIntent:'create_plan', expectedTopic:'概率', expectedDeckHint:D.STAT, expectedParent:'统计学', expectedConcepts:['概率','分布','贝叶斯'], mustMatchAny:['概率','分布','贝叶斯'], maxMerged:100, minFinal:2, category:'复习补弱', domain:'统计学', style:'我对X很薄弱' },
