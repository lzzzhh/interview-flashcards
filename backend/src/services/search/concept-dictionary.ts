...
const STATIC_CONCEPTS: ConceptEntry[] = [
  ...
  { topic: '概率', canonicalTopic: '概率', deckHint: 'statistics', parentCategory: '统计学',
    ...
    lowPriorityKeywords: ['统计学'] },
  { topic: 'SVM', canonicalTopic: 'SVM', deckHint: 'machine-learning', parentCategory: '机器学习',
    subtopics: [], coreKeywords: ['SVM', 'support vector machine'],
    expandedKeywords: ['核函数', '最大间隔', '拉格朗日', 'dual problem', 'KKT', 'SMO'],
    lowPriorityKeywords: ['机器学习'] },
  { topic: '特征工程', canonicalTopic: '特征工程', deckHint: 'machine-learning', parentCategory: '机器学习',
    subtopics: [], coreKeywords: ['特征工程', 'feature engineering'],
    expandedKeywords: ['特征选择', '特征提取', '特征缩放', '编码', '缺失值', '特征哈希'],
    lowPriorityKeywords: ['机器学习'] },
  { topic: 'BatchNorm', canonicalTopic: 'BatchNorm', deckHint: 'deep-learning', parentCategory: '深度学习',
    subtopics: [], coreKeywords: ['BatchNorm', 'batch normalization'],
    expandedKeywords: ['normalization', 'internal covariate shift', 'LayerNorm', 'training stability'],
    lowPriorityKeywords: ['深度学习'] },
  { topic: 'LayerNorm', canonicalTopic: 'LayerNorm', deckHint: 'deep-learning', parentCategory: '深度学习',
    subtopics: [], coreKeywords: ['LayerNorm', 'layer normalization'],
    expandedKeywords: ['normalization', 'batch norm vs layer norm', 'NLP normalization'],
    lowPriorityKeywords: ['深度学习'] },
  { topic: 'RNN', canonicalTopic: 'RNN', deckHint: 'deep-learning', parentCategory: '深度学习',
    subtopics: [], coreKeywords: ['RNN', 'recurrent neural network', 'LSTM'],
    expandedKeywords: ['GRU', '序列', '梯度消失', 'time step', '双向RNN'],
    lowPriorityKeywords: ['深度学习'] },
  { topic: 'CNN', canonicalTopic: 'CNN', deckHint: 'deep-learning', parentCategory: '深度学习',
    subtopics: [], coreKeywords: ['CNN', 'convolutional neural network'],
    expandedKeywords: ['卷积', 'pooling', 'filter', 'stride', 'padding', 'feature map'],
    lowPriorityKeywords: ['深度学习'] },
  { topic: 'Dropout', canonicalTopic: 'Dropout', deckHint: 'deep-learning', parentCategory: '深度学习',
    subtopics: [], coreKeywords: ['Dropout', 'drop out'],
    expandedKeywords: ['正则化', 'ensemble', 'inverted dropout', 'drop connect'],
    lowPriorityKeywords: ['深度学习'] },
  { topic: '优化器', canonicalTopic: '优化器', deckHint: 'deep-learning', parentCategory: '深度学习',
    subtopics: [], coreKeywords: ['优化器', 'optimizer'],
    expandedKeywords: ['SGD', 'Adam', 'RMSprop', 'AdamW', 'momentum', '学习率'],
    lowPriorityKeywords: ['深度学习'] },
  { topic: '损失函数', canonicalTopic: '损失函数', deckHint: 'deep-learning', parentCategory: '深度学习',
  ...
  { topic: 'Fine-tuning', canonicalTopic: 'Fine-tuning', deckHint: 'llm', parentCategory: '大模型',
    ...
    lowPriorityKeywords: ['大模型'] },
  { topic: 'Embedding', canonicalTopic: 'Embedding', deckHint: 'llm', parentCategory: '大模型',
    subtopics: [], coreKeywords: ['Embedding', '嵌入', '向量'],
    expandedKeywords: ['word2vec', 'BERT embedding', 'ANN', 'vector DB', 'Milvus', 'Pinecone', 'sentence embedding'],
    lowPriorityKeywords: ['大模型'] },
  { topic: '前缀和', canonicalTopic: '前缀和', deckHint: 'leetcode', parentCategory: '算法',
    subtopics: [], coreKeywords: ['前缀和', 'prefix sum'],
    expandedKeywords: ['preSum', 'cumulative sum', '区间和', '差分数组', 'subarray sum'],
    lowPriorityKeywords: ['算法'] },
  { topic: 'Function Calling', canonicalTopic: 'Function Calling', deckHint: 'agent', parentCategory: 'Agent',
    subtopics: [], coreKeywords: ['Function Calling', '工具调用', 'tool use'],
    expandedKeywords: ['OpenAI function', 'tool call', 'plugin', 'API', 'JSON schema'],
    lowPriorityKeywords: ['Agent'] },
  { topic: '单调栈', canonicalTopic: '单调栈', deckHint: 'leetcode', parentCategory: '算法',
    subtopics: [], coreKeywords: ['单调栈', 'monotonic stack'],
    expandedKeywords: ['单调递减', '单调递增', '下一个更大元素', '柱状图', 'daily temperatures'],
    lowPriorityKeywords: ['算法'] },
  { topic: 'VibeCoding', canonicalTopic: 'VibeCoding', deckHint: 'vibe-coding', parentCategory: 'VibeCoding',
    subtopics: [], coreKeywords: ['VibeCoding', 'Vibe Coding'],
    expandedKeywords: ['氛围编程', 'AI辅助编程', '快速原型', 'prompt engineering', '自然语言编程'],
    lowPriorityKeywords: [] },
  { topic: '双指针和哈希表', canonicalTopic: '双指针', deckHint: 'leetcode', parentCategory: '算法',
    subtopics: [], coreKeywords: ['双指针', '哈希表', 'two pointer', 'hash'],
    expandedKeywords: ['对撞指针', '快慢指针', '滑动窗口', '去重'],
    lowPriorityKeywords: ['算法'] },
  { topic: '连通性', canonicalTopic: '连通性', deckHint: 'leetcode', parentCategory: '算法',
