...
export const SUB_MODULES: Record<string, SubModuleMeta[]> = {
  ...
  'deep-learning': [
    { key: 'dl-basics',        label: '深度学习基础', category: 'deep-learning', subTopic: '深度学习基础', color: 'bg-purple-500' },
    { key: 'dl-generative',    label: '生成模型',     category: 'deep-learning', subTopic: '生成模型',     color: 'bg-pink-500' },
    { key: 'dl-other',         label: '其他专题',     category: 'deep-learning', subTopic: '',             color: 'bg-gray-400' },
  ],
  llm: [
    { key: 'llm-transformer',  label: 'Transformer',  category: 'llm', subTopic: 'Transformer', color: 'bg-blue-500' },
    { key: 'llm-finetune',     label: '训练微调',     category: 'llm', subTopic: '训练微调',    color: 'bg-green-500' },
    { key: 'llm-inference',    label: '推理部署',     category: 'llm', subTopic: '推理部署',    color: 'bg-orange-500' },
    { key: 'llm-other',        label: '其他专题',     category: 'llm', subTopic: '',            color: 'bg-gray-400' },
  ],
  agent: [
    { key: 'agent-core',       label: 'Agent核心',    category: 'agent', subTopic: 'Agent', color: 'bg-indigo-500' },
    { key: 'agent-rag',        label: 'RAG',          category: 'agent', subTopic: 'RAG',   color: 'bg-teal-500' },
  ],
  jargon: [
